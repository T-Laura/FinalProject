...
public class Board implements ActionListener
{
   ...
   private Image[][] queenImages = {{new ImageIcon("Images/WhiteQueenLightSquare.png").getImage(), new ImageIcon("Images/WhiteQueenDarkSquare.png").getImage()}      //Second image in this row will not show
